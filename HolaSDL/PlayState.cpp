...
//devolvemos el tipo de casilla en funci�n de una posici�n dada
...
//comprobamos si los fantasmas y el pac-man est�n en la misma posici�n y actuamos en consecuencia
...
//Comprueba si el siguiente pixel es v�lido para moverse
...
void PlayState::reproduce(SmartGhost* _father, Ghost* couple)
{
	...
	//Si no hay hueco, pues no se crea ning�n fantasma
...
//Dada una poscici�n y un n que hace referencia al tipo de celda, cambiamos el valor en el mapa
