...
enum TextureName { WallMap, Characters, Food, Digits, PowerUp, exitButton, mainButton,	playButton , saveButton, resumeButton, loadButton, Title, Bg};
...
private:
	...
	const TextureAtributes TEXTURE_ATRIB[NUM_TEXTURES] = { {"../images/wall3.png", 1, 1}, {"../images/characters.png", 4, 14} , {"../images/food2.png", 1, 1}, 
			...
			{"../images/save.png", 1, 2},{"../images/resume.png", 1, 2}, {"../images/load.png", 1, 2}, {"../images/title.png", 1, 1}, {"../images/bg.jpg", 1, 1} };
	//ARRAY DE NIVELES
